...
const faqCategories = [
  ...
  },
  {
    ...
    faqs: [
      { q: 'How do calls get to the AI?', a: "There are three options. (1) Forward your existing business number to the AI number using your phone's call forwarding—callers dial the same number they always have. (2) Use the AI number directly as your business number on your website, ads, and cards. (3) A hybrid approach: forward when you're busy or on a job, answer directly when you're available." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'How do SMS notifications work?', a: "Immediately after each call, the business owner receives a text message with the key details: who called, why they called, the AI's summary, and how urgent it is. They can see at a glance whether they need to call back immediately or if it can wait. Demo and admin calls also send SMS summaries." },
      ...
      { q: 'Is there a mobile app for clients?', a: 'The client dashboard is fully responsive and works great on mobile devices. Clients can add it to their home screen for an app-like experience with one tap. SMS and email notifications work on all devices.' },
    ],
  },
  {
    id: 'hipaa-medical',
    ...
    faqs: [
      { q: 'Is VoiceAI Connect HIPAA compliant?', a: 'Yes. VoiceAI Connect offers a HIPAA mode that can be enabled per client from the Settings tab. When active, HIPAA mode disables call recording storage, disables transcript storage, turns off caller recognition, and forces all appointments into "collect request" mode. The AI is trained to never ask about or discuss specific medical information on calls. Only scheduling information is collected and stored: name, phone number, and general reason for the visit.' },
      ...
      { q: 'Do you offer a Business Associate Agreement (BAA)?', a: 'Yes. We provide a BAA for agencies and clients handling healthcare calls. Contact support@myvoiceaiconnect.com to request a BAA before onboarding medical or dental clients.' },
      ...
      { q: 'Can the AI distinguish between new and existing patients?', a: 'Yes. The AI asks "Are you a current patient or would this be your first visit?" and adjusts the conversation accordingly. With caller recognition enabled (disabled in HIPAA mode), it can also look up returning callers by phone number and greet them by name.' },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'What happens if the AI system goes down?', a: "Our platform has 99.9% uptime with redundant systems. In the extremely rare event of an outage, calls can be configured to automatically forward to a backup number (like the client's cell phone) so no calls are lost." },
    ],
  },
  {
    id: 'getting-clients',
    ...
    faqs: [
      ...
      { q: 'Can I offer free trials to potential clients?', a: 'Yes, and we recommend it. Every plan includes a 7-day free trial for the businesses you onboard. Once they see missed calls drop to zero and experience the convenience, they almost always convert. Our data shows 68% of trials convert to paid.' },
      { q: 'How quickly can I expect to be profitable?', a: "Most agencies become profitable within the first month. On the Free plan, there's no platform fee—you're profitable with your first client. On Pro ($99/mo), two clients at $99+ makes you profitable. The fastest agencies sign their first paying client within 1-2 weeks of launching." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'Do you have an API?', a: 'Yes, Pro and Scale plans include REST API access. You can use the API to manage clients programmatically, access call data, and integrate with your existing systems. Full API documentation is available in your agency dashboard.' },
      { q: 'Can agencies receive webhook notifications?', a: 'Yes. Agencies can configure webhook URLs to receive real-time POST notifications when calls end, appointments are booked, and other events occur. Payloads include full call data and are HMAC-signed for security. This allows agencies to pipe call events into their own CRMs, Zapier, Make, n8n, or any custom system.' },
      { q: 'What integrations are available?', a: 'Google Calendar for appointment booking (all plans), Stripe Connect for payments, and webhook/API support for connecting to CRMs, automation tools, and other systems. Since Google Calendar syncs natively with HubSpot, Salesforce, Calendly, and other platforms, appointments flow through automatically.' },
      ...
      { q: 'What about website chat or other channels?', a: 'VoiceAI Connect is purpose-built for voice/phone calls, which is where most small businesses lose the most revenue. Website chat is not currently supported, but the webhook and API infrastructure allows agencies to connect the platform into broader multi-channel systems if needed.' },
    ],
  },
  {
    id: 'security',
    ...
    faqs: [
      { q: 'Is my data secure?', a: 'Yes, security is a top priority. All data is encrypted at rest and in transit. We use Supabase with Postgres row-level security, ensuring agencies and clients can only access their own data. Infrastructure runs on SOC 2-compliant vendors. PII is never persisted in application logs.' },
      { q: 'Where is data stored?', a: 'All data is stored in secure data centers in the United States with redundant backups. We use enterprise-grade cloud infrastructure with 99.9% uptime guarantees.' },
      ...
      { q: 'Can recordings be disabled?', a: "Yes. HIPAA mode disables call recording storage entirely. Even outside HIPAA mode, the platform supports configuring recording preferences per client. When recordings are disabled, AI summaries and SMS notifications still function—the caller's information is captured without storing the audio file." },
    ],
  },
  {
    id: 'support',
    ...
    faqs: [
      { q: 'What kind of support do you offer?', a: 'The Free plan includes email support. Pro plans add priority email support with faster response times. Scale plans include dedicated success managers, phone support, and SLA guarantees. All plans include access to documentation and onboarding resources.' },
      { q: 'Do you help with onboarding?', a: 'Yes. All plans include onboarding documentation and video tutorials. Pro plans include a guided onboarding session. Scale plans include white-glove onboarding with a dedicated success manager.' },
      { q: 'What if my clients have technical issues?', a: "You handle client support to maintain your white-label positioning. For technical issues you can't resolve, submit support tickets on behalf of your clients. We work with you behind the scenes to resolve issues quickly—your clients never interact with us directly." },
      { q: "What happens if I need a feature that doesn't exist?", a: 'We ship new features regularly based on agency feedback. You can submit feature requests through your dashboard. Scale plan customers get priority consideration for feature requests.' },
    ],
  },
  {
    id: 'account',
