...
const faqCategories = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'Can agencies use their own website instead of the included marketing site?', a: 'Yes. The platform provides a white-label marketing site automatically, but agencies can use their own website for marketing and lead generation instead. The client signup API endpoint is public, and agencies can link to the /get-started signup flow from any external site. The included marketing site is optional, and many agencies use both.' },
    ],
  },
  {
