...
export default function HomePage() {
  ...
  const layers = [
    ...
    { n: '04', icon: Mic, title: 'An AI receptionist that never sleeps', sub: "The voice agent answers calls 24/7 in multiple languages, books appointments directly to the client's calendar, transfers urgent matters to the business owner in real time, and writes a summary on every interaction.", features: ['Sub-two-second response latency on every call', 'Native calendar and CRM integrations', 'Multilingual voice synthesis included'] },
      ...
      <section id="pricing" className="bg-ink py-28 lg:py-40 scroll-mt-24 border-t border-white/[0.04] relative overflow-hidden">
        ...
        <div className="max-w-[1280px] mx-auto px-6 lg:px-10 relative">
          ...
          <div className="grid lg:grid-cols-3 gap-4 max-w-5xl">
            {[
              { name: 'Free', price: 0, desc: 'Start building — no commitment', features: ['Unlimited clients', 'AI receptionist per client', 'Call notifications + spam detection', '$29.99/client/mo + $0.12/min', 'Stripe Connect billing'], limits: ['No white-label branding', 'No marketing site'] },
              { name: 'Pro', price: 179, desc: 'Growing agencies — full white-label', pop: true, features: ['Unlimited clients', 'Full white-label branding', 'Marketing website + AI demo line', 'Lead generation CRM', 'Up to 5 team members', '$9.99/client/mo + $0.10/min'], limits: [] },
              { name: 'Scale', price: 499, desc: 'Established agencies at volume', features: ['Unlimited clients', 'Everything in Pro', 'AI Lab + industry templates', 'Unlimited team members', '$0/client + $0.05/min only', 'Priority support'], limits: [] },
            ].map(t => (
