      ...
      <section id="pricing" className="bg-ink py-28 lg:py-40 scroll-mt-24 border-t border-white/[0.04] relative overflow-hidden">
        ...
        <div className="max-w-[1280px] mx-auto px-6 lg:px-10 relative">
          ...
          <div className="grid lg:grid-cols-3 gap-4 max-w-5xl">
            {[
              { name: 'Free', price: 0, desc: 'Start building — no commitment', features: ['AI receptionist for every client', 'Call notifications + spam detection', 'Caller recognition + after-hours mode', '$29.99/client/mo + $0.12/min', 'Stripe Connect billing'], limits: ['No white-label branding', 'No marketing site'] },
              { name: 'Pro', price: 99, desc: 'Growing agencies — full white-label', pop: true, features: ['Full white-label branding', 'Custom domain', 'Marketing website + AI demo line', 'Lead generation CRM', 'Team members', '$9.99/client/mo + $0.10/min'], limits: [] },
