      ...
      <section id="platform" className="bg-ink py-28 lg:py-40 border-t border-white/[0.04] scroll-mt-24">
        <div className="max-w-[1280px] mx-auto px-6 lg:px-10">
          ...
          <div className="bento">
            ...
            <div className="bento-cell bento-c2"><div className="bento-cell-content"><p className="t-eyebrow text-em flex items-center gap-2"><Wand2 className="w-3 h-3" />Automation</p><p className="font-display text-[15px] text-white mt-3 leading-snug font-medium">Make and n8n event hooks fire on every platform action.</p></div></div>
