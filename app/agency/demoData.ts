...
//
// UPDATED: 2026-06-09 — Scaled up to feel like an established agency
// (32 clients, $3,200 MRR, $24K lifetime, 6 referrals). Numbers pumped from
// previous "starter agency" feel to "growing successful agency" feel — better
// for screen recordings, referral pitches, and live demos.
// ============================================================================
...
export const DEMO_DASHBOARD = {
  clientCount: 32,
  mrr: 320000, // cents = $3,200.00
  totalCalls: 2417,
  recentClients: [
    {
      id: 'demo-client-30',
      business_name: 'PrismShine Detailing',
      status: 'active',
...
export const DEMO_CLIENTS = [
  ...
  {
    id: 'demo-client-15',
    business_name: 'Apex Heating & Cooling',
    email: 'service@apexhc.com',
    owner_name: 'Mark Reynolds',
    owner_phone: '+14045551015',
    plan_type: 'pro',
    subscription_status: 'active',
    status: 'active',
    calls_this_month: 73,
    created_at: daysAgo(95),
    vapi_phone_number: '+14705559015',
  },
  {
    id: 'demo-client-16',
    business_name: 'Bluebird Lawn Care',
    email: 'info@bluebirdlawn.com',
    owner_name: 'Helen Adams',
    owner_phone: '+14045551016',
    plan_type: 'starter',
    subscription_status: 'active',
    status: 'active',
    calls_this_month: 36,
    created_at: daysAgo(110),
    vapi_phone_number: '+14705559016',
  },
  {
    id: 'demo-client-17',
    business_name: 'ChimneyMaster Sweep Co.',
    email: 'book@chimneymaster.com',
    owner_name: 'Eric Russo',
    owner_phone: '+14045551017',
    plan_type: 'pro',
    subscription_status: 'active',
    status: 'active',
    calls_this_month: 58,
    created_at: daysAgo(125),
    vapi_phone_number: '+14705559017',
  },
  {
    id: 'demo-client-18',
    business_name: 'DriveSafe Auto Glass',
    email: 'service@drivesafeglass.com',
    owner_name: 'Tina Pham',
    owner_phone: '+14045551018',
    plan_type: 'starter',
    subscription_status: 'active',
    status: 'active',
    calls_this_month: 33,
    created_at: daysAgo(135),
    vapi_phone_number: '+14705559018',
  },
  {
    id: 'demo-client-19',
    business_name: 'EvergreenLandscape Design',
    email: 'studio@evergreenld.com',
    owner_name: 'Carlos Reyes',
    owner_phone: '+14045551019',
    plan_type: 'pro',
    subscription_status: 'active',
    status: 'active',
    calls_this_month: 69,
    created_at: daysAgo(140),
    vapi_phone_number: '+14705559019',
  },
  {
    id: 'demo-client-20',
    business_name: 'FortressLock Security Systems',
    email: 'dispatch@fortresslock.com',
    owner_name: 'Wendy Carter',
    owner_phone: '+14045551020',
    plan_type: 'growth',
    subscription_status: 'active',
    status: 'active',
    calls_this_month: 121,
    created_at: daysAgo(155),
    vapi_phone_number: '+14705559020',
  },
  {
    id: 'demo-client-21',
    business_name: 'GlideRight Garage Doors',
    email: 'info@gliderightgarage.com',
    owner_name: 'Brian Holt',
    owner_phone: '+14045551021',
    plan_type: 'pro',
    subscription_status: 'active',
    status: 'active',
    calls_this_month: 52,
    created_at: daysAgo(170),
    vapi_phone_number: '+14705559021',
  },
  {
    id: 'demo-client-22',
    business_name: 'HandyHelp Home Repairs',
    email: 'office@handyhelphr.com',
    owner_name: 'Lisa Bauer',
    owner_phone: '+14045551022',
    plan_type: 'starter',
    subscription_status: 'active',
    status: 'active',
    calls_this_month: 28,
    created_at: daysAgo(180),
    vapi_phone_number: '+14705559022',
  },
  {
    id: 'demo-client-23',
    business_name: 'InsideOut Window Solutions',
    email: 'quotes@insideoutwindows.com',
    owner_name: 'David Yoon',
    owner_phone: '+14045551023',
    plan_type: 'pro',
    subscription_status: 'active',
    status: 'active',
    calls_this_month: 47,
    created_at: daysAgo(200),
    vapi_phone_number: '+14705559023',
  },
  {
    id: 'demo-client-24',
    business_name: 'JoyfulMoves Moving Co.',
    email: 'hello@joyfulmoves.com',
    owner_name: 'Sandra Klein',
    owner_phone: '+14045551024',
    plan_type: 'growth',
    subscription_status: 'active',
    status: 'active',
    calls_this_month: 138,
    created_at: daysAgo(220),
    vapi_phone_number: '+14705559024',
  },
  {
    id: 'demo-client-25',
    business_name: 'KinetiCool HVAC Repair',
    email: 'service@kineticool.com',
    owner_name: 'Phil Nakamura',
    owner_phone: '+14045551025',
    plan_type: 'pro',
    subscription_status: 'active',
    status: 'active',
    calls_this_month: 79,
    created_at: daysAgo(240),
    vapi_phone_number: '+14705559025',
  },
  {
    id: 'demo-client-26',
    business_name: 'LegacyTree Care Specialists',
    email: 'estimates@legacytree.com',
    owner_name: 'Maria Costello',
    owner_phone: '+14045551026',
    plan_type: 'pro',
    subscription_status: 'active',
    status: 'active',
    calls_this_month: 64,
    created_at: daysAgo(260),
    vapi_phone_number: '+14705559026',
  },
  {
    id: 'demo-client-27',
    business_name: 'MountainMover Excavation',
    email: 'office@mountainmover.com',
    owner_name: 'Rick Petersen',
    owner_phone: '+14045551027',
    plan_type: 'starter',
    subscription_status: 'active',
    status: 'active',
    calls_this_month: 41,
    created_at: daysAgo(275),
    vapi_phone_number: '+14705559027',
  },
  {
    id: 'demo-client-28',
    business_name: 'NovaGlow Pressure Washing',
    email: 'book@novaglow.com',
    owner_name: 'Sara Wynn',
    owner_phone: '+14045551028',
    plan_type: 'starter',
    subscription_status: 'active',
    status: 'active',
    calls_this_month: 25,
    created_at: daysAgo(290),
    vapi_phone_number: '+14705559028',
  },
  {
    id: 'demo-client-29',
    business_name: 'OakRidge Fence & Deck',
    email: 'quotes@oakridgefd.com',
    owner_name: 'Glenn Saunders',
    owner_phone: '+14045551029',
    plan_type: 'pro',
    subscription_status: 'active',
    status: 'active',
    calls_this_month: 56,
    created_at: daysAgo(310),
    vapi_phone_number: '+14705559029',
  },
  {
    id: 'demo-client-30',
    business_name: 'PrismShine Detailing',
    email: 'service@prismshine.com',
    owner_name: 'Eddie Vargas',
    owner_phone: '+14045551030',
    plan_type: 'pro',
    subscription_status: 'trialing',
    status: 'active',
    calls_this_month: 11,
    created_at: daysAgo(7),
    vapi_phone_number: '+14705559030',
  },
  {
    id: 'demo-client-31',
    business_name: 'QualityFirst Painting',
    email: 'estimates@qualityfirstpaint.com',
    owner_name: 'Margaret Hill',
    owner_phone: '+14045551031',
    plan_type: 'growth',
    subscription_status: 'active',
    status: 'active',
    calls_this_month: 109,
    created_at: daysAgo(340),
    vapi_phone_number: '+14705559031',
  },
  {
    id: 'demo-client-32',
    business_name: 'RapidResponse Plumbing',
    email: 'dispatch@rapidresponseplumb.com',
    owner_name: 'Wesley Brooks',
    owner_phone: '+14045551032',
    plan_type: 'pro',
    subscription_status: 'active',
    status: 'active',
    calls_this_month: 89,
    created_at: daysAgo(360),
    vapi_phone_number: '+14705559032',
  },
];
...
export const DEMO_ANALYTICS = {
  stats: {
    mrr: 320000,
    totalEarned: 2435000,  // $24,350
    pendingPayout: 87400,  // $874
    activeClients: 28,
    trialClients: 4,
    totalClients: 32,
  },
  revenueByMonth: [
    { month: monthStr(5), amount: 95000 },   // $950
    { month: monthStr(4), amount: 142000 },  // $1,420
    { month: monthStr(3), amount: 198000 },  // $1,980
    { month: monthStr(2), amount: 245000 },  // $2,450
    { month: monthStr(1), amount: 287000 },  // $2,870
    { month: monthStr(0), amount: 320000 },  // $3,200
  ],
  revenueByPlan: {
    starter: 49000,   // $490 — 10 active starter × $49
    pro: 178200,      // $1,782 — 18 active pro × $99
    growth: 92800,    // $928 — ~6 active growth (mix of $149)
  },
  payments: [
    ...
    { id: 'demo-pay-4', client_id: 'demo-client-20', amount: 14900, status: 'paid', type: 'subscription', created_at: daysAgo(4), paid_out: false, client_name: 'FortressLock Security Systems' },
    { id: 'demo-pay-5', client_id: 'demo-client-4', amount: 9900, status: 'paid', type: 'subscription', created_at: daysAgo(5), paid_out: true, client_name: 'BrightStar Electric' },
    { id: 'demo-pay-6', client_id: 'demo-client-7', amount: 9900, status: 'paid', type: 'subscription', created_at: daysAgo(5), paid_out: true, client_name: 'Diamond Auto Detailing' },
    { id: 'demo-pay-7', client_id: 'demo-client-24', amount: 14900, status: 'paid', type: 'subscription', created_at: daysAgo(6), paid_out: true, client_name: 'JoyfulMoves Moving Co.' },
    { id: 'demo-pay-8', client_id: 'demo-client-11', amount: 14900, status: 'paid', type: 'subscription', created_at: daysAgo(7), paid_out: true, client_name: 'Apex Moving Co.' },
    { id: 'demo-pay-9', client_id: 'demo-client-9', amount: 9900, status: 'paid', type: 'subscription', created_at: daysAgo(8), paid_out: true, client_name: 'Ironclad Fencing' },
    { id: 'demo-pay-10', client_id: 'demo-client-25', amount: 9900, status: 'paid', type: 'subscription', created_at: daysAgo(9), paid_out: true, client_name: 'KinetiCool HVAC Repair' },
    { id: 'demo-pay-11', client_id: 'demo-client-31', amount: 14900, status: 'paid', type: 'subscription', created_at: daysAgo(10), paid_out: true, client_name: 'QualityFirst Painting' },
    { id: 'demo-pay-12', client_id: 'demo-client-3', amount: 4900, status: 'paid', type: 'subscription', created_at: daysAgo(10), paid_out: true, client_name: 'GreenScape Lawn Care' },
    { id: 'demo-pay-13', client_id: 'demo-client-14', amount: 9900, status: 'paid', type: 'subscription', created_at: daysAgo(12), paid_out: true, client_name: 'SafeGuard Locksmith' },
    { id: 'demo-pay-14', client_id: 'demo-client-10', amount: 4900, status: 'paid', type: 'subscription', created_at: daysAgo(14), paid_out: true, client_name: 'TrueNorth Pest Control' },
    { id: 'demo-pay-15', client_id: 'demo-client-17', amount: 9900, status: 'paid', type: 'subscription', created_at: daysAgo(15), paid_out: true, client_name: 'ChimneyMaster Sweep Co.' },
  ],
...
export const DEMO_REFERRALS = {
  ...
  stats: {
    totalReferrals: 6,
    activeReferrals: 5,
    lifetimeEarnings: 1284000,    // $12,840
    availableBalance: 478000,     // $4,780
    thisMonthEarnings: 220000,    // $2,200
  },
  referrals: [
    {
      id: 'demo-ref-1',
    ...
    {
      id: 'demo-ref-4',
      name: 'Pinnacle Growth Partners',
      slug: 'pinnacle-growth',
      status: 'active',
      subscription_status: 'active',
      plan_type: 'professional',
      created_at: daysAgo(55),
  ...
  commissions: [
    ...
    },
    {
      ...
      created_at: daysAgo(5),
      transferred_at: null,
      referred: { name: 'Nova Media Group', slug: 'nova-media' },
    },
    {
      id: 'demo-comm-4',
      commission_amount_cents: 7960,
      ...
      transferred_at: null,
      referred: { name: 'Pinnacle Growth Partners', slug: 'pinnacle-growth' },
    },
    {
      id: 'demo-comm-5',
      commission_amount_cents: 3960,
      ...
      created_at: daysAgo(8),
      transferred_at: null,
      referred: { name: 'Catalyst Local Agency', slug: 'catalyst-local' },
    },
    {
      id: 'demo-comm-6',
      commission_amount_cents: 7960,
