  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
      ...
      <div className="mb-6 sm:mb-8">
        ...
        <p className="mt-1 text-sm text-[#fafaf9]/50">Track a potential client in your pipeline</p>
      </div>
            ...
            <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-4 sm:p-6">
              ...
              <div className="space-y-3 sm:space-y-4">
                <div>
                  ...
                  <p className="text-[10px] sm:text-xs text-[#fafaf9]/30 mt-1">Expected monthly revenue</p>
                </div>
                <div>
