...
import { ArrowRight, Check, ChevronRight, Menu, X, BarChart3, TrendingUp, Clock, Phone } from 'lucide-react';
...
export default function AnalyticsFeaturePage() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-[#fafaf9] overflow-hidden">
      ...
      <div className="pt-24 sm:pt-28"><div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8"><div className="flex items-center gap-2 text-sm text-[#fafaf9]/40"><Link href="/features" className="hover:text-[#fafaf9]">Features</Link><ChevronRight className="h-4 w-4" /><span className="text-[#fafaf9]/60">Analytics</span></div></div></div>

      <section className="relative pt-8 sm:pt-12 pb-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 rounded-full border border-emerald-500/20 bg-emerald-500/[0.08] px-4 py-1.5 text-sm mb-6"><BarChart3 className="h-4 w-4 text-emerald-400" /><span className="text-emerald-300/90">All Plans</span></div>
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-semibold tracking-tight leading-[1.1]">See what&apos;s working.<span className="block mt-2 text-[#fafaf9]/40">Data for every call.</span></h1>
              <p className="mt-6 text-lg sm:text-xl text-[#fafaf9]/60 leading-relaxed">Track call volumes, peak times, average duration, and more. Show your clients the value you&apos;re delivering with beautiful, shareable reports.</p>
              <div className="mt-8 space-y-3">
                {['Call volume trends', 'Average call duration', 'Peak hours analysis', 'Outcome tracking'].map((item) => (
            ...
            <div className="relative">
              ...
              <div className="relative rounded-2xl border border-white/[0.08] bg-[#0a0a0a] p-6">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <span className="text-xs text-[#fafaf9]/40">Jan 2026</span>
                </div>
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="p-4 rounded-lg bg-white/[0.03]">
                    <p className="text-2xl font-bold">342</p>
                    <p className="text-xs text-[#fafaf9]/40">Total Calls</p>
                    <p className="text-xs text-emerald-400 mt-1">↑ 12% vs last month</p>
                  </div>
                  <div className="p-4 rounded-lg bg-white/[0.03]">
                    <p className="text-2xl font-bold">2:34</p>
                    <p className="text-xs text-[#fafaf9]/40">Avg Duration</p>
                    <p className="text-xs text-[#fafaf9]/40 mt-1">→ No change</p>
                  </div>
                </div>
                <div className="p-4 rounded-lg bg-white/[0.03]">
                  <p className="text-sm font-medium mb-3">Call Volume by Day</p>
                  <div className="flex items-end gap-1 h-20">
                    {[40, 65, 45, 80, 55, 30, 25].map((h, i) => (
                      <div key={i} className="flex-1 bg-emerald-500/30 rounded-t" style={{ height: `${h}%` }} />
                    ))}
                  </div>
                  <div className="flex justify-between mt-2 text-xs text-[#fafaf9]/30">
      ...
      <section className="py-16 border-t border-white/[0.06]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            {[
              { title: 'Exports', desc: 'Download reports and data', href: '/features/exports' },
              { title: 'Mobile Dashboard', desc: 'Stats on the go', href: '/features/mobile-dashboard' },
              { title: 'Call Recordings', desc: 'Review individual calls', href: '/features/call-recordings' },
            ].map((item) => (
      ...
      <section className="py-16 border-t border-white/[0.06]">
        <div className="mx-auto max-w-4xl px-4 text-center">
          <h2 className="text-2xl font-semibold">Data that proves your value</h2>
          <p className="mt-4 text-[#fafaf9]/50">Call analytics included in all plans.</p>
