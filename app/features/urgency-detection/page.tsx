...
import { ArrowRight, Check, ChevronRight, Menu, X, AlertTriangle, Bell, Zap, Phone } from 'lucide-react';
...
export default function UrgencyDetectionFeaturePage() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-[#fafaf9] overflow-hidden">
      ...
      <div className="pt-24 sm:pt-28"><div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8"><div className="flex items-center gap-2 text-sm text-[#fafaf9]/40"><Link href="/features" className="hover:text-[#fafaf9]">Features</Link><ChevronRight className="h-4 w-4" /><span className="text-[#fafaf9]/60">Urgency Detection</span></div></div></div>

      <section className="relative pt-8 sm:pt-12 pb-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 rounded-full border border-amber-500/20 bg-amber-500/[0.08] px-4 py-1.5 text-sm mb-6"><AlertTriangle className="h-4 w-4 text-amber-400" /><span className="text-amber-300/90">All Plans</span></div>
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-semibold tracking-tight leading-[1.1]">AI knows what&apos;s urgent.<span className="block mt-2 text-[#fafaf9]/40">And alerts accordingly.</span></h1>
              <p className="mt-6 text-lg sm:text-xl text-[#fafaf9]/60 leading-relaxed">Our AI automatically classifies calls by urgency level. Emergency? Instant priority alert. Routine inquiry? Normal notification. Your clients respond to what matters most.</p>
              <div className="mt-8 space-y-3">
                {['Automatic urgency classification', 'Priority alerts for emergencies', 'Industry-specific urgency rules', 'Escalation triggers available'].map((item) => (
            ...
            <div className="relative">
              ...
              <div className="relative rounded-2xl border border-white/[0.08] bg-[#0a0a0a] p-6">
                <h3 className="font-medium mb-4">Urgency Classification</h3>
                <div className="space-y-3">
                  <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/30">
                    <div className="flex items-center gap-2 mb-2"><div className="h-3 w-3 rounded-full bg-red-500 animate-pulse" /><span className="text-red-400 font-medium">🚨 URGENT</span></div>
                    <p className="text-sm text-[#fafaf9]/70">&quot;Water is flooding my basement right now!&quot;</p>
                    <p className="text-xs text-red-400 mt-2">→ Instant call + SMS alert sent</p>
                  </div>
                  <div className="p-4 rounded-lg bg-amber-500/10 border border-amber-500/20">
                    <div className="flex items-center gap-2 mb-2"><div className="h-3 w-3 rounded-full bg-amber-500" /><span className="text-amber-400 font-medium">⚡ IMPORTANT</span></div>
                    <p className="text-sm text-[#fafaf9]/70">&quot;My AC stopped working, it&apos;s getting hot.&quot;</p>
                    <p className="text-xs text-amber-400 mt-2">→ Priority SMS notification</p>
                  </div>
                  <div className="p-4 rounded-lg bg-white/[0.03] border border-white/[0.06]">
                    <div className="flex items-center gap-2 mb-2"><div className="h-3 w-3 rounded-full bg-emerald-500" /><span className="text-emerald-400 font-medium">✓ NORMAL</span></div>
                    <p className="text-sm text-[#fafaf9]/70">&quot;I&apos;d like to schedule a routine checkup.&quot;</p>
                    <p className="text-xs text-[#fafaf9]/40 mt-2">→ Standard notification</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 border-t border-white/[0.06]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {[
              { step: '1', title: 'AI analyzes the call', desc: 'Detects keywords, tone, and context in real-time.' },
              { step: '2', title: 'Classifies urgency', desc: 'Assigns urgent, important, or normal status.' },
              { step: '3', title: 'Triggers alerts', desc: 'Sends appropriate notifications based on level.' },
            ].map((item) => (
      ...
      <section className="py-16 border-t border-white/[0.06]">
        <div className="mx-auto max-w-4xl px-4 text-center">
          <h2 className="text-2xl font-semibold">AI that knows what matters most</h2>
          <p className="mt-4 text-[#fafaf9]/50">Urgency detection included in all plans.</p>
