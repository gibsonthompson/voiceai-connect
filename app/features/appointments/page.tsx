...
import { ArrowRight, Check, ChevronRight, Menu, X, Calendar, Clock, CheckCircle, Users } from 'lucide-react';
...
export default function AppointmentsFeaturePage() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-[#fafaf9] overflow-hidden">
      ...
      <div className="pt-24 sm:pt-28"><div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8"><div className="flex items-center gap-2 text-sm text-[#fafaf9]/40"><Link href="/features" className="hover:text-[#fafaf9]">Features</Link><ChevronRight className="h-4 w-4" /><span className="text-[#fafaf9]/60">Appointment Booking</span></div></div></div>

      <section className="relative pt-8 sm:pt-12 pb-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 rounded-full border border-emerald-500/20 bg-emerald-500/[0.08] px-4 py-1.5 text-sm mb-6"><Calendar className="h-4 w-4 text-emerald-400" /><span className="text-emerald-300/90">All Plans</span></div>
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-semibold tracking-tight leading-[1.1]">AI books appointments.<span className="block mt-2 text-[#fafaf9]/40">Directly into their calendar.</span></h1>
              <p className="mt-6 text-lg sm:text-xl text-[#fafaf9]/60 leading-relaxed">Connect to Google Calendar, Calendly, or other scheduling tools. AI checks availability and books appointments in real-time—no back and forth needed.</p>
              <div className="mt-8 space-y-3">
                {['Google Calendar integration', 'Calendly & Cal.com support', 'Real-time availability check', 'Automatic confirmation sent'].map((item) => (
            ...
            <div className="relative">
              ...
              <div className="relative rounded-2xl border border-white/[0.08] bg-[#0a0a0a] p-6">
                <h3 className="font-medium mb-4">Live Booking Flow</h3>
                <div className="space-y-4">
                  <div className="flex gap-3"><div className="h-8 w-8 rounded-full bg-white/10 flex items-center justify-center shrink-0 text-sm">🗣️</div><div className="p-3 rounded-xl bg-white/[0.05] text-sm flex-1">&quot;I&apos;d like to book an appointment for Thursday.&quot;</div></div>
                  <div className="flex gap-3 justify-end"><div className="p-3 rounded-xl bg-emerald-500/10 border border-emerald-500/20 text-sm max-w-[85%]">&quot;Let me check Thursday availability... I have 10am, 2pm, and 4pm open. Which works best for you?&quot;</div></div>
                  <div className="flex gap-3"><div className="h-8 w-8 rounded-full bg-white/10 flex items-center justify-center shrink-0 text-sm">🗣️</div><div className="p-3 rounded-xl bg-white/[0.05] text-sm flex-1">&quot;2pm works great.&quot;</div></div>
                  <div className="flex gap-3 justify-end"><div className="p-3 rounded-xl bg-emerald-500/10 border border-emerald-500/20 text-sm max-w-[85%]">&quot;Perfect! I&apos;ve booked you for Thursday at 2pm. You&apos;ll receive a confirmation text shortly.&quot;</div></div>
                </div>
                <div className="flex items-center gap-2 mt-4 pt-4 border-t border-white/[0.06]">
                  <CheckCircle className="h-4 w-4 text-emerald-400" />
                  <p className="text-xs text-emerald-400">Appointment synced to Google Calendar</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 border-t border-white/[0.06]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-semibold text-center mb-12">Integrations</h2>
          <div className="grid sm:grid-cols-4 gap-6">
            {['Google Calendar', 'Calendly', 'Cal.com', 'Custom API'].map((item) => (
              <div key={item} className="p-6 rounded-xl border border-white/[0.06] bg-white/[0.02] text-center">
                <Calendar className="h-8 w-8 mx-auto mb-3 text-emerald-400" />
      ...
      <section className="py-16 border-t border-white/[0.06]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            {[
              { title: 'Business Hours', desc: 'Intelligent scheduling rules', href: '/features/business-hours' },
              { title: 'Notifications', desc: 'Booking confirmations', href: '/features/notifications' },
              { title: 'Knowledge Base', desc: 'AI learns services', href: '/features/knowledge-base' },
            ].map((item) => (
      ...
      <section className="py-16 border-t border-white/[0.06]">
        <div className="mx-auto max-w-4xl px-4 text-center">
          <h2 className="text-2xl font-semibold">AI that books appointments while they sleep</h2>
          <p className="mt-4 text-[#fafaf9]/50">Calendar integration included in all plans.</p>
