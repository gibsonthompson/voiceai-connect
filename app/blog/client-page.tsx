...
const blogPosts: BlogPost[] = [
  // =========================================================================
  // AEO CONTENT — AI Search Engine Optimization (March 2026)
  // =========================================================================
  {
    slug: 'missed-call-cost-small-business',
    title: 'How Much Do Missed Calls Actually Cost a Small Business?',
    excerpt: 'Small businesses lose $20,000–$126,000 per year to unanswered phone calls. Industry-by-industry breakdown with data sources, a cost calculator formula, and what to do about it.',
    category: 'industry',
  ...
  {
    slug: 'ai-receptionist-vs-ivr-vs-answering-service',
    title: 'AI Receptionist vs. Answering Service vs. IVR: What\'s the Difference?',
    excerpt: 'Four products businesses use to handle phone calls, explained side by side. What each one does, what it costs, where it falls short, and how to decide.',
    category: 'industry',
    author: { name: 'Gibson Thompson' },
    publishedAt: '2026-03-10',
  ...
  {
    slug: 'how-to-sell-ai-to-local-businesses',
    title: 'How to Sell AI Receptionist Services to Local Business Owners',
    excerpt: 'The actual sales process for closing local businesses on AI receptionist services. Specific conversations, objection handling, demo techniques, pricing, and where to find prospects.',
    category: 'guides',
    author: { name: 'Gibson Thompson' },
    publishedAt: '2026-03-10',
  ...
  {
    slug: 'what-is-ai-receptionist-how-it-works',
    title: 'What Is an AI Receptionist and How Does It Work?',
    excerpt: 'An AI receptionist answers your business calls using natural language processing. Step-by-step explanation of the technology, with a real call example and FAQ.',
    category: 'industry',
    author: { name: 'Gibson Thompson' },
    publishedAt: '2026-03-10',
  ...
  },
  {
    ...
    excerpt: 'Set up an AI receptionist in under an hour. What you need before you start, step-by-step configuration, how to test it, and common mistakes that make the AI sound bad.',
    category: 'guides',
    author: { name: 'Gibson Thompson' },
    publishedAt: '2026-03-10',
    readTime: '12 min read',
  ...
  {
    slug: 'what-can-ai-receptionist-handle',
    title: 'What Can an AI Receptionist Actually Handle? (With Real Examples)',
    excerpt: 'Specific examples of what AI receptionists can and can\'t do. Real conversation scenarios for plumbing, dental, legal, restaurants, and auto repair.',
    category: 'guides',
    author: { name: 'Gibson Thompson' },
    publishedAt: '2026-03-10',
  ...
  {
    slug: 'ai-receptionist-after-hours-calls',
    title: 'AI Receptionist for After-Hours Calls: How It Works and Why It Matters',
    excerpt: '22% of new leads call after business hours. An AI receptionist captures them instantly — booking appointments and routing emergencies while you sleep.',
    category: 'guides',
    author: { name: 'Gibson Thompson' },
  ...
  },
  {
    ...
    excerpt: 'Calculate the exact ROI of an AI receptionist. Worked examples for plumbing, dental, legal, and restaurants. Most businesses break even with one extra captured call per month.',
    category: 'industry',
    author: { name: 'Gibson Thompson' },
    publishedAt: '2026-03-11',
    readTime: '11 min read',
  ...
  {
    slug: 'white-label-saas-business-model-explained',
    title: 'White-Label SaaS Business Model Explained: How Resellers Make Money',
    excerpt: 'What a white-label SaaS business model is, how the three-tier value chain works, why margins are 60–80%, and how it compares to affiliate, dropshipping, and agency models.',
    category: 'guides',
    author: { name: 'Gibson Thompson' },
    publishedAt: '2026-03-11',
    readTime: '12 min read',
  ...
  {
    slug: 'onboard-first-ai-receptionist-client',
    title: 'How to Onboard Your First AI Receptionist Client (Step-by-Step)',
    excerpt: 'The complete onboarding process from signed contract to live calls. What to collect, how to configure, testing protocol, and first-week follow-up that prevents cancellation.',
    category: 'guides',
    author: { name: 'Gibson Thompson' },
    publishedAt: '2026-03-11',
    readTime: '13 min read',
  ...
  {
    slug: 'reduce-churn-ai-receptionist-agency',
    title: 'How to Reduce Churn in an AI Receptionist Agency (Practical Playbook)',
    excerpt: 'AI receptionist agencies average 5–8% monthly churn. The best run 2–3%. Specific retention tactics — onboarding fixes, usage reporting, save conversations — that close the gap.',
    category: 'guides',
    author: { name: 'Gibson Thompson' },
    publishedAt: '2026-03-11',
    readTime: '14 min read',
  ...
  {
    slug: 'ai-receptionist-agency-tech-stack',
    title: 'AI Receptionist Agency Tech Stack: Every Tool You Need in 2026',
    excerpt: 'The complete tool stack at every stage. What you need at 0 clients vs 50 clients — white-label platform, CRM, outreach tools, automation — and what you don\'t.',
    category: 'guides',
    author: { name: 'Gibson Thompson' },
    publishedAt: '2026-03-11',
    readTime: '11 min read',
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 sm:h-20 items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-8">
              <Link href="/#features" className="text-sm text-[#fafaf9]/60 hover:text-[#fafaf9] transition-colors">Features</Link>
              <Link href="/#pricing" className="text-sm text-[#fafaf9]/60 hover:text-[#fafaf9] transition-colors">Pricing</Link>
              <Link href="/blog" className="text-sm text-[#fafaf9] font-medium">Blog</Link>
            </nav>
            <div className="flex items-center gap-3">
              <Link href="/agency/login" className="text-sm text-[#fafaf9]/60 hover:text-[#fafaf9] transition-colors">Sign In</Link>
              <Link href="/signup" className="hidden sm:inline-flex items-center gap-2 rounded-full bg-white px-4 py-2 text-sm font-medium text-[#050505] hover:bg-[#fafaf9] transition-colors">
                Start Free Trial
                <ArrowRight className="h-4 w-4" />
              </Link>
            </div>
      ...
      <main className="relative pt-28 sm:pt-32 pb-16 px-4 sm:px-6">
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-semibold tracking-tight">Insights & Resources</h1>
            <p className="mt-4 text-lg text-[#fafaf9]/50 max-w-2xl mx-auto">Guides, industry insights, and product updates to help you build and grow your AI voice agency.</p>
          </div>
          <div className="flex flex-col sm:flex-row gap-4 mb-10 sm:mb-12">
            <div className="relative flex-1 max-w-md">
              ...
              <input type="text" placeholder="Search articles..." value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} className="w-full rounded-xl border border-white/[0.08] bg-white/[0.03] pl-12 pr-4 py-3 text-[#fafaf9] placeholder:text-[#fafaf9]/30 focus:outline-none focus:border-white/20 focus:bg-white/[0.05] transition-all" />
            </div>
            <div className="flex flex-wrap gap-2">
              {categories.map((category) => (
                <button key={category.id} onClick={() => setSelectedCategory(category.id)} className={`rounded-full px-4 py-2 text-sm font-medium transition-all ${selectedCategory === category.id ? 'bg-emerald-500 text-[#050505]' : 'bg-white/[0.05] text-[#fafaf9]/70 hover:bg-white/[0.1] border border-white/[0.08]'}`}>
                  {category.name}
                </button>
              ))}
            </div>
          ...
          {featuredPosts.length > 0 && selectedCategory === 'all' && !searchQuery && (
            <section className="mb-12 sm:mb-16">
              <h2 className="text-sm font-medium text-[#fafaf9]/40 uppercase tracking-wider mb-6">Featured</h2>
          ...
          <section>
            {(featuredPosts.length > 0 && selectedCategory === 'all' && !searchQuery) && (
              <h2 className="text-sm font-medium text-[#fafaf9]/40 uppercase tracking-wider mb-6">All Articles</h2>
            )}
            {filteredPosts.length > 0 ? (
              ...
              <div className="text-center py-16">
                ...
                <button onClick={() => { setSelectedCategory('all'); setSearchQuery(''); }} className="mt-4 text-emerald-400 hover:text-emerald-300 text-sm font-medium">Clear filters</button>
              </div>
            )}
          </section>
          <section className="mt-16 sm:mt-20">
            <div className="relative rounded-2xl sm:rounded-3xl border border-white/[0.08] bg-white/[0.02] p-8 sm:p-12 overflow-hidden">
              ...
              <div className="relative max-w-2xl">
                <h2 className="text-2xl sm:text-3xl font-semibold tracking-tight">Stay in the loop</h2>
                <p className="mt-3 text-[#fafaf9]/50">Get the latest guides, industry insights, and product updates delivered to your inbox.</p>
                <form className="mt-6 flex flex-col sm:flex-row gap-3">
                  <input type="email" placeholder="Enter your email" className="flex-1 rounded-xl border border-white/[0.08] bg-white/[0.03] px-4 py-3 text-[#fafaf9] placeholder:text-[#fafaf9]/30 focus:outline-none focus:border-white/20 focus:bg-white/[0.05] transition-all" />
                  <button type="submit" className="inline-flex items-center justify-center gap-2 rounded-full bg-white px-6 py-3 text-sm font-medium text-[#050505] hover:bg-[#fafaf9] transition-all hover:scale-[1.02] active:scale-[0.98]">
                    Subscribe
                    <ArrowRight className="h-4 w-4" />
                  </button>
                </form>
                <p className="mt-4 text-xs text-[#fafaf9]/30">No spam. Unsubscribe anytime.</p>
              </div>
            </div>
          </section>
        </div>
