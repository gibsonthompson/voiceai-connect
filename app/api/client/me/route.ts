    ...
    return NextResponse.json({
      client: {
        ...
        agency: clientData.agencies ? {
          ...
          secondary_color: clientData.agencies.secondary_color,
          accent_color: clientData.agencies.accent_color,
          support_email: clientData.agencies.support_email,
          support_phone: clientData.agencies.support_phone,
          website_theme: clientData.agencies.website_theme,
