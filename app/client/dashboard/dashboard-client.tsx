...
export function ClientDashboardClient({
  ...
  useEffect(() => {
    const saved = localStorage.getItem('client-dashboard-theme');
    if (saved) {
  ...
  const toggleTheme = () => {
    ...
    setDarkMode(newMode);
    localStorage.setItem('client-dashboard-theme', newMode ? 'dark' : 'light');
  };
      ...
      >
        ...
        >
          <div 
            ...
            style={{ borderColor: hexToRgba(branding.primaryColor, 0.2), backgroundColor: 'rgba(255,255,255,0.02)' }}
          >
