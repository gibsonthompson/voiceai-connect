...
const GoogleCalendarIcon = ({ className = '' }: { className?: string }) => (
  <svg viewBox="0 0 48 48" className={className} xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <path fill="#e53935" d="M9,6h5v8H6V9C6,7.343,7.343,6,9,6z" />
    <path fill="#43a047" d="M42,34v5c0,1.657-1.343,3-3,3h-5v-8H42z" />
  </svg>
);
            ...
            {calendarLoading ? (
              ...
              <div className="space-y-3">
                <button onClick={handleConnectCalendar} className="w-full flex items-center justify-center gap-2.5 py-2.5 sm:py-3 rounded-xl text-sm font-semibold transition hover:shadow-sm" style={{ backgroundColor: theme.card, color: theme.text, border: `1px solid ${theme.border}` }}>
                  <GoogleCalendarIcon className="w-[18px] h-[18px]" /> Connect Google Calendar
                </button>
