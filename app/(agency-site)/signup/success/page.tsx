...
function SuccessContent() {
  ...
  useEffect(() => {
    ...
    // Check for client data from URL params or sessionStorage
  ...
  const handleCopyPhone = () => {
    if (clientData?.phone_number) {
      navigator.clipboard.writeText(clientData.phone_number);
      setCopied(true);
          ...
          <div className="rounded-2xl border border-white/10 bg-[#111] p-8 text-center">
            ...
            <p className="text-[#f5f5f0]/50 mb-8">
              {clientData?.business_name 
                ? `Your AI receptionist for ${clientData.business_name} is ready.`
                ...
                >
                  ...
                  >
                    {copied ? (
                      ...
                      <Copy className="h-5 w-5 text-[#f5f5f0]/50" />
                    )}
                  </button>
                </div>
              </div>
            ...
            <div className="text-left mb-8">
              ...
              <ul className="space-y-3">
                {[
                  ...
                  'Forward your business calls to your AI number',
                  'Log into your dashboard to view calls',
                ].map((step, i) => (
...
export default function AgencySiteSuccessPage() {
  return (
    <Suspense fallback={
      <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center">
        <Loader2 className="h-8 w-8 animate-spin text-white/50" />
