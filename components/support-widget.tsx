...
const FAQ_DATA: FAQItem[] = [
  { category: 'Platform', question: 'How does white-labeling work?', answer: "Every client-facing surface is branded to your agency — logo, color palette, custom domain with auto-provisioned SSL, transactional emails, marketing website, and the phone experience itself. Your clients interact only with your brand. VoiceAI Connect is never visible to the businesses you serve at any point — from signup through ongoing usage to billing." },
  { category: 'Pricing', question: 'What do agencies charge their clients?', answer: "Most agencies charge between $99 and $299 per month per client for AI receptionist services. Industry data shows the cost of a single missed call is roughly $500 for a small service business, and a full-time human receptionist runs approximately $3,000/month. AI receptionist coverage at $149/month is a clear yes for most local businesses — and your margins stay above 85%." },
  { category: 'Setup', question: 'How fast can I onboard a client?', answer: "Under sixty seconds. A local business fills out your branded signup form, and the platform automatically provisions their AI voice agent, dedicated phone number, dashboard credentials, and welcome email sequence. No A2P registration delay, no manual setup." },
  { category: 'Features', question: 'Is the AI demo line included?', answer: "Yes — on the Pro tier and above. Each agency receives a dedicated demo phone number that prospects can call to experience the AI receptionist firsthand. It is the strongest conversion tool on the platform." },
  ...
  { category: 'Comparison', question: 'How is this different from GoHighLevel?', answer: "GoHighLevel is a multi-purpose marketing platform designed for managing client campaigns. VoiceAI Connect is purpose-built for one thing: AI receptionist resale. Three concrete differences — end clients receive their own branded dashboard (GHL does not), client onboarding completes in under sixty seconds (GHL requires per-client A2P registration that takes days), and the agency interface is mobile-first (GHL is desktop-bound)." },
  { category: 'Features', question: 'Does the AI book appointments?', answer: "Yes — Google Calendar integration is included on every plan, including Free. When a caller requests an appointment, the AI checks the business owner's Google Calendar for available time slots in real time, offers options, and books it on the spot." },
  { category: 'Pricing', question: 'What does it cost to get started?', answer: "The Free tier has no platform fee — agencies pay $29.99 per client per month plus $0.12 per minute. The Pro tier costs $99/month with full white-label branding, marketing website, and demo line, with reduced per-client ($9.99) and per-minute ($0.10) rates. Pro and Scale include a 14-day free trial with no credit card required." },
  { category: 'Platform', question: 'Do my clients know about VoiceAI Connect?', answer: "No. The entire experience is branded to your agency. Your clients log into a dashboard with your logo, receive emails from your domain, and interact with an AI that greets callers using your brand name. VoiceAI Connect is the invisible infrastructure layer." },
  { category: 'Features', question: 'Can the AI handle Spanish callers?', answer: "Yes — automatic English and Spanish on every plan, no configuration required. The AI detects when a caller speaks Spanish and switches languages for the entire conversation." },
  { category: 'Data', question: 'Is call data used for AI training?', answer: "No. VoiceAI Connect never uses call data, transcriptions, or recordings to train AI models. The underlying AI providers also do not train on API-submitted data per their terms of service." },
  { category: 'Support', question: 'Who handles client support?', answer: "You are the point of contact for your clients — that is the white-label model. Your clients interact with your brand and never contact VoiceAI Connect directly. On our side, we provide platform support to you as the agency operator." },
];
